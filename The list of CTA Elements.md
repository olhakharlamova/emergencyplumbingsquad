# The List of CTA Elements (Cleaned - Active Templates Only)

This document contains all Call-to-Action (CTA) elements found in the **ACTIVE** WordPress theme (`ppl-ninja-child2`), organized by type and file location.

**Note:** This list has been cleaned to include only templates that are actually being used on the live site. Inactive templates from `ppl-ninja` and `ppl-ninja-child` themes have been removed.
...
| `wp-content/themes/ppl-ninja-child2/template-cta.php` | 113 | `<a href="tel:8558122311" class="ut_cta_button">` | `wi_cta-tel-templatecta-btn-all` |
| `wp-content/themes/ppl-ninja-child2/header-24henm.php` | 770 | `<div class="EmergencyPlumbingsquad-24hr-Button-Container"><a href="tel:(855) 916-4406"` | `wi_cta-tel-header24henm-btn-all` |
| `wp-content/themes/ppl-ninja-child2/page.php` | 44 | `<a class="desk" href="tel:8558122311" data-text="CALL (855) 812-2311 NOW">CALL (855) 812-2311 NOW</a>` | `wi_cta-tel-page-desktop` |
| `wp-content/themes/ppl-ninja-child2/single.php` | 20 | `<a class="desk" href="tel:8558122311" data-text="CALL (855) 812-2311 NOW">CALL (855) 812-2311 NOW</a>` | `wi_cta-tel-single-desktop` |
| `wp-content/themes/ppl-ninja-child2/new-location-page.php` | 45 | `<a class="desk" href="tel:8558122311" data-text="CALL (855) 812-2311 NOW">CALL (855) 812-2311 NOW</a>` | `wi_cta-tel-newlocation-desktop` |
| `wp-content/themes/ppl-ninja-child2/new-location-page.php` | 75 | `<a class="wi_main_not_found_button"href="tel:8558122311">` | `wi_cta-tel-newlocation-notfound-all` |
| `wp-content/themes/ppl-ninja-child2/new-location-page.php` | 101 | `<h3>Step #1 - Call us: <a href="tel:8558122311">(855) 812-2311</a></h3>` | `wi_cta-tel-newlocation-step1-all` |
| `wp-content/themes/ppl-ninja-child2/new-location-page.php` | 116 | `<p style="padding: 0 0 30px 0;"><a href="tel:8558122311">CALL (855) 812-2311 NOW</a></p>` | `wi_cta-tel-newlocation-call-all` |
| `wp-content/themes/ppl-ninja-child2/new-location-page.php` | 138 | `<p>Need a plumber immediately? Call us at <a href="tel:8558122311">(855) 812-2311</a> for 24-hour emergency plumbing services.</p>` | `wi_cta-tel-newlocation-text-all` |
| `wp-content/themes/ppl-ninja-child2/new-location-page.php` | 152 | `<p>Call <a href="tel:8558122311">(855) 812-2311</a> when you need a plumber, and we'll handle the rest for you.</p>` | `wi_cta-tel-newlocation-text2-all` |
| `wp-content/themes/ppl-ninja-child2/new-location-page.php` | 161 | `<p style="padding: 0 0 30px 0;"><a href="tel:8558122311">CALL (855) 812-2311 NOW</a></p>` | `wi_cta-tel-newlocation-call2-all` |
| `wp-content/themes/ppl-ninja-child2/new-state-template.php` | 41 | `<a class="desk" href="tel:8558122311" data-text="CALL (855) 812-2311 NOW">CALL (855) 812-2311 NOW</a>` | `wi_cta-tel-newstate-desktop` |
| `wp-content/themes/ppl-ninja-child2/new-state-template.php` | 77 | `<button> <a class="exo_button" href="tel:8558122311"><i class="icon-phone"> </i> CALL NOW: (855) 812-2311</a></button>` | `wi_cta-tel-newstate-btn-all` |
| `wp-content/themes/ppl-ninja-child2/page-front-l1.php` | 574 | `<p class="copy"><a class="phone-number" href="tel:8558122311">(855) 812-2311</a>` | `wi_cta-tel-pagefrontl1-copy-all` |
| `wp-content/themes/ppl-ninja-child2/page-front-l1.php` | 605 | `<p><a class="desktop-only" href="tel:8558122311">CALL (855) 812-2311 NOW</a>` | `wi_cta-tel-pagefrontl1-desktop` |
| `wp-content/themes/ppl-ninja-child2/page-front-l1.php` | 606 | `<a class="mobile-only" href="tel:8558122311">` | `wi_cta-tel-pagefrontl1-mobile` |
...
## Summary (Cleaned - Active Templates Only)
